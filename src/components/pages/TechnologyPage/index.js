...
const TechnologyPage = () => {
  const technologyState = useSelector(
    (state) => state.technologyReducer.technology
  );
      ...
      {isDesktopOrLaptop && (
        <div className={styles.container}>
          ...
          <SwitchTransition mode="out-in">
            ...
            >
              <img
                src={showImagePortrait(technology)}
                alt={technology.name}
                className={styles.img_portrait}
              />
            </CSSTransition>
          </SwitchTransition>
        </div>
      ...
      {isTabletOrMobile && (
        <div className={styles.container}>
          <SwitchTransition mode="out-in">
            ...
            >
              <img
                src={showImageLandscape(technology)}
                alt={technology.name}
                className={styles.img_landscape}
              />
            </CSSTransition>
          </SwitchTransition>
          <ul className={styles.nav_container}>
